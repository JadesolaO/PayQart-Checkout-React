...
import '../stylesheets/scss/employementscreen.scss'
          ...
          <Col md={9} xs={12}>
            ...
            <Row className='justify-content-md-center mb-4'>
              <Col className='mx-3 boxs' md={3}>
                <div className="options" tabIndex='1' onClick={() => setEmploymentType('Paid employment')}>
                  <div>
              ...
              <Col className='mx-3 boxs' md={3}>
                <div className="options" tabIndex='2' onClick={() => setEmploymentType('self employed/ freelance')}>
                  <div>
                    <Image
                      fluid
                      src={free}
              ...
              <Col className='mx-3 boxs' md={3}>
                <div className="options" tabIndex='3' onClick={() => setEmploymentType('small business')}>
                  <div>
                    <Image
                      fluid
                      src={coop}
